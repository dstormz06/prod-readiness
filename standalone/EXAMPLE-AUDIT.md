...
*Sample output produced with READINESS AUDITOR v3.17. The tool, firm, application number, and staff names below are invented for illustration. This is not a record of any real review, product, or system.*
...
*Method: READINESS AUDITOR v3.17 · 64 controls · 7 lenses. Verdict derived mechanically: 3 blockers present → NOT CLEARED.*
...
*Method: READINESS AUDITOR v3.17 · 64 controls · 7 lenses. Verdict derived mechanically: 0 blockers, 2 serious → CLEARED WITH CONDITIONS.*
